...
//      _animationController3, _animationController4;
//
//  @override
//  void initState() {
//    super.initState();
...
//                ),
//                icon: Icon(
//                    Icons.favorite_border, size: 24, color: Colors.white),
//              ),
//            ),
//            SlideTransition(
...
//    var hasMovie = snapshot.connectionState == ConnectionState.done &&
//        snapshot?.data?.result?.isNotEmpty == true &&
//        (snapshot?.data?.result.length > _currentPage);
//    if (hasMovie) {
...
//                  image: CachedNetworkImageProvider(IMAGE_PREFIX +
//                      snapshot?.data?.result[_currentPage].backdrop),
//                  fit: BoxFit.cover,
//                ),
//              ),
...
//                    MaterialPageRoute(
//                        builder: (BuildContext _) {
//                          return MovieDetailPage(id: snapshot.data
//                              ?.result[index].id);
//                        }
//                    )
//                );
